package com.example.batch.worker.exports.testing;
 ...
 *
 * <p>Used in tests that need to verify Excel import/export round-trips without
 * committing binary fixture files to source control.
 *
 * <p>Usage:
 * <pre>{@code
...
public final class TestExcelFileBuilder {
    ...
    private final java.util.List<List<Object>> rows = new java.util.ArrayList<>();
     ...
     * Keys not present in headers are ignored.
     */
    ...
    /** Builds a customer import .xlsx with standard columns and the given data rows. */
    ...
    /** Builds a minimal single-row .xlsx for a given sheet name and values. */
