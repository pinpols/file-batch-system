 ...
 * com.example.batch.trigger.infrastructure.QuartzLaunchJob} 的 tenant-suspend 自愈分支、 {@link
 * com.example.batch.trigger.web.TriggerManagementController} 的运维 API)无法注入。
 *
