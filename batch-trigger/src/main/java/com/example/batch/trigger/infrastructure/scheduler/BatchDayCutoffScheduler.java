...
public class BatchDayCutoffScheduler {
    ...
    public void cutoff() {
        ...
        List<BatchDayCutoffCandidate> candidates =
                batchDayInstanceMapper.selectOpenCutoffCandidates();
        ...
        for (BatchDayCutoffCandidate candidate : candidates) {
            ...
            if (updated > 0) {
                log.info(
                        "batch day cutoff applied: tenantId={}, calendarCode={}, bizDate={},"
                            + " cutoffAt={}",
                        candidate.getTenantId(),
                        candidate.getCalendarCode(),
                        candidate.getBizDate(),
