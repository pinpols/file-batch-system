...
完整可跑示范: [`examples/self-hosted-sdk/sample-tenant-worker-python/`](../../examples/self-hosted-sdk/sample-tenant-worker-python/)。
...
[`examples/self-hosted-sdk/sample-tenant-worker-python/`](../../examples/self-hosted-sdk/sample-tenant-worker-python/)
是 Java `sample-tenant-worker-java/` 的 Python 对等示例。两个演示
