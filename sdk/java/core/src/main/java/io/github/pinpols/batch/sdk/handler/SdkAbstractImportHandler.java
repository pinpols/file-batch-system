...
import io.github.pinpols.batch.sdk.handler.typed.SdkAbstractTypedImportHandler;
 ...
 * @param <R> 行类型
 */
// S112 抑制：租户 SPI 刻意声明宽泛 throws Exception，允许租户实现抛任意受检异常；
// 收窄为具体异常会破坏已接入租户的编译兼容性。
