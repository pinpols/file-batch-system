...
/**
 * A.4 — 声明式重试。标在 {@link io.github.pinpols.batch.sdk.task.SdkTaskHandler} 实现类上,声明「整个 handler 执行遇到
 * 指定异常时按退避策略重试」。
 *
 ...
 *
 * <p><b>织入方式</b>:与 {@link io.github.pinpols.batch.sdk.idempotent.Idempotent} 一致,用显式装饰器 {@link
