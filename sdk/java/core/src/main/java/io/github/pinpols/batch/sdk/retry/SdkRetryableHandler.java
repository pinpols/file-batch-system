 ...
 *
 * <p><b>为何用装饰器</b>:与 {@link io.github.pinpols.batch.sdk.idempotent.SdkIdempotentHandler} 同理 —— SDK
 * core 禁 Spring,改用显式 {@link #wrap}。退避数学复用 {@link SdkRetryPolicy}(initial / nextDelay / sleepFor)。
 *
 * <p><b>两种失败形态都覆盖</b>:
 *
 * <ul>
