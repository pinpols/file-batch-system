...
| **P2** (this PR) | Kafka consumer (aiokafka), `TaskDispatcher` (CLAIM/EXECUTE/REPORT), capacity-aware pause, tenant self-check, provisional `run_worker` entrypoint | done (Lane S) |
