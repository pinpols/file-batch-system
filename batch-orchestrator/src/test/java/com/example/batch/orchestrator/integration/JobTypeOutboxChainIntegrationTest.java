...
class JobTypeOutboxChainIntegrationTest extends AbstractIntegrationTest {
    ...
    void importJobShouldWriteImportOutboxEvent() {
        ...
        launchService.launch(new LaunchRequest(
                ...
                seed.requestId(), "tr-import", Map.of()));
    ...
    void exportJobShouldWriteExportOutboxEvent() {
        ...
        launchService.launch(new LaunchRequest(
                TENANT, seed.jobCode(), LocalDate.of(2026, 1, 15), TriggerType.MANUAL,
                seed.requestId(), "tr-export", Map.of()));
    ...
    void dispatchJobShouldWriteDispatchOutboxEvent() {
        ...
        launchService.launch(new LaunchRequest(
                TENANT, seed.jobCode(), LocalDate.of(2026, 1, 15), TriggerType.EVENT,
                seed.requestId(), "tr-dispatch", Map.of()));
