...
class DefaultTaskOutcomeServiceTest {
    ...
    void setUp() {
        ...
        service = new DefaultTaskOutcomeService(jobMappers, workflowMappers, retryGovernanceService,
                stateMachine, workflowDagService, workflowNodeDispatchServiceProvider);
    }
    ...
    void applyTaskOutcome_selectByQueryForUpdate_usedForPartitionCounting() throws Exception {
        ...
        var method = DefaultTaskOutcomeService.class.getDeclaredMethod(
