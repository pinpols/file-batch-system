...
class DefaultWorkflowNodeDispatchServiceIdempotencyTest {
    ...
    void setUp() {
        OrchestratorJobMappers jobMappers = new OrchestratorJobMappers(
                jobInstanceMapper, jobPartitionMapper, jobTaskMapper, jobStepInstanceMapper, triggerRequestMapper);
        ...
        service = new DefaultWorkflowNodeDispatchService(jobMappers, workflowMappers,
                schedulePlanBuilder, partitionLifecycleService, taskDispatchOutboxService,
                workflowDagService, resourceScheduler, taskExecutionServiceProvider, launchServiceProvider);
    }
    ...
    void dispatchNode_nodeAlreadyActive_usesSelectLatestForUpdate() {
        ...
        WorkflowDagService.DagNodeResolution node = new WorkflowDagService.DagNodeResolution("NODE_A", "TASK");
