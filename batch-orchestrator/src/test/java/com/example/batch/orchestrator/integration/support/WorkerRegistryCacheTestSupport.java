 ...
 * 渗入生产代码（IMPORT / DEFAULT / IT / 空 group 4 个 worker_group 一次性 evict 是测试夹具需求,生产
 * 永远走单 group {@link WorkerRegistryCache#evict(String, String)}）。
 *
...
public final class WorkerRegistryCacheTestSupport {
   ...
   *
   * <p>覆盖 {@code IMPORT} / {@code DEFAULT} / {@code IT} 以及空白 worker_group 对应的 {@code _}
   * 占位键(与 {@code WorkerRegistryCache#key} 的空组规范化一致)。
   */
