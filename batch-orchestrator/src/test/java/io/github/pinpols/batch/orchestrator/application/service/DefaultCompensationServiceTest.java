...
class DefaultCompensationServiceTest {
  ...
  void shouldRerunStepSuccessfully_STEP_path() {
    ...
    io.github.pinpols.batch.orchestrator.domain.entity.JobStepInstanceEntity step =
        new io.github.pinpols.batch.orchestrator.domain.entity.JobStepInstanceEntity();
    step.setId(5L);
