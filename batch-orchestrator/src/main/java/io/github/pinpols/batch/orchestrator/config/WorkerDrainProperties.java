...
public class WorkerDrainProperties {
  ...
  /**
   * 是否装载 {@link
   * io.github.pinpols.batch.orchestrator.infrastructure.scheduler.WorkerHeartbeatTimeoutScheduler}。
   * 默认为 true（生产必须开启）；integration profile 通常会关闭以免 seed worker 无续心跳误判离线。
   */
