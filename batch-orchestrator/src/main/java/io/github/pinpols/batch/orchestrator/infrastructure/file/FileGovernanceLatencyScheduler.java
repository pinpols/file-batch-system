 ...
 * 文件治理——延迟指标采集调度器。
 *
 * <p>默认每 30 秒触发一次，委托 {@link FileGovernanceScheduler#collectLatencyMetrics()} 采集文件到达延迟与处理延迟等监控指标并写入
 * Redis 缓存。 ShedLock 锁名 {@code file_governance_latency}，最长持锁 2 分钟，最短持锁 15 秒，
