 ...
 *
 * <p><b>重置策略</b>（{@link io.github.pinpols.batch.orchestrator.domain.scheduling.QuotaResetPolicy}）：
 *
 * <ul>
 ...
 *       io.github.pinpols.batch.orchestrator.infrastructure.quota.RedisQuotaRuntimeStateService}
 *       Lua 原子脚本实现，无 PG 行级锁竞争，承担派发热路径
 *   <li>{@code database} → {@link
 *       io.github.pinpols.batch.orchestrator.infrastructure.quota.DatabaseQuotaRuntimeStateService}
