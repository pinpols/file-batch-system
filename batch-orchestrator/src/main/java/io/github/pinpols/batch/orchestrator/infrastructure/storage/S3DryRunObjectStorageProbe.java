...
/** S3 兼容对象存储 dry-run 探测适配器，负责 bucket 命名校验和存在性检查。 */
@Component
public final class S3DryRunObjectStorageProbe implements DryRunObjectStorageProbe {
  ...
  public S3DryRunObjectStorageProbe(
