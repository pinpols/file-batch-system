...
public class RuntimeBasedPartitionCountResolver implements PartitionCountResolver {
  ...
  public int resolve(
    ...
    long historicalDurationSeconds = PartitionCountResolverSupport.firstPositiveLong(
        RuntimeBasedPartitionCountResolver.class,
        params.get("historicalAverageDurationSeconds"),
        params.get("historicalDurationSeconds"),
        params.get("expectedDurationSeconds"));
    int targetDurationSeconds = PartitionCountResolverSupport.firstPositiveInt(
        RuntimeBasedPartitionCountResolver.class,
