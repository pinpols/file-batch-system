...
public class TokenBucketRateLimiter {
    ...
    public boolean tryConsume(String tenantId, String action, long maxPerMinute, long nowEpochMillis) {
        if (maxPerMinute <= 0) {
            return true;
        }
        ...
        Long current = redis.incrementWithinWindow(tenantId, action, windowStartEpochSecond, WINDOW_TTL);
