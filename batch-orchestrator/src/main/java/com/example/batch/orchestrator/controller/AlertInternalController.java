...
/**
 * 告警事件内部接收控制器，基础路径 {@code /internal/alerts}。
 * 提供单一端点 {@code POST /internal/alerts}，供内部服务推送告警事件，
 * 委托 {@link com.example.batch.orchestrator.application.service.AlertEventService} 处理后续分发。
 * 仅限内部网络调用，不对外暴露。
 */
@RestController
