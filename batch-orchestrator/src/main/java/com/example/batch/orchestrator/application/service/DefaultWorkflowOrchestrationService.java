 ...
 *
 * <p>该类将 {@link SchedulePlan} 委托给 {@link ScheduleForwarder#advance(SchedulePlan)} 推进，
 * 自身不包含编排逻辑，仅承担 Spring Bean 注册和接口适配职责。
 * 编排核心逻辑由 {@code ScheduleForwarder} 负责，确保编排行为可替换而不影响调用方。
 */
@Service
