...
public interface TenantSchedulerSnapshotRepository
        extends CrudRepository<TenantSchedulerSnapshotRecord, Long> {
    ...
    List<TenantSchedulerSnapshotRecord> listRecent(
            @Param("tenantId") String tenantId, @Param("lim") int limit);
}
