...
public class ApprovalController {
    ...
    public ApprovalRecordResponse get(@PathVariable String approvalNo, @RequestParam String tenantId) {
        return new ApprovalRecordResponse(approvalWorkflowService.get(tenantId, approvalNo));
    }

    @PostMapping("/{approvalNo}/approve")
    public ApprovalRecordResponse approve(@PathVariable String approvalNo, @RequestBody ApprovalActionRequest request) {
    ...
    public ApprovalRecordResponse reject(@PathVariable String approvalNo, @RequestBody ApprovalActionRequest request) {
    ...
    public ApprovalRecordResponse executed(@PathVariable String approvalNo, @RequestBody ApprovalTenantRequest request) {
        return new ApprovalRecordResponse(approvalWorkflowService.markExecuted(request.tenantId(), approvalNo));
    }

    public record ApprovalRequest(String tenantId,
                                  String approvalType,
                                  String actionType,
                                  String targetType,
                                  String targetId,
    ...
    public record ApprovalActionRequest(String tenantId,
                                        String operatorId,
                                        String reason) {
    }
