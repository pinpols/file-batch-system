...
public record BatchDayInstanceRecord(
    ...
    public BatchDayInstanceRecord withSettled(String dayStatus, Instant settledAt, Instant updatedAt) {
        return new BatchDayInstanceRecord(id, tenantId, calendarCode, bizDate, dayStatus, openAt,
                cutoffAt, settledAt, slaDeadlineAt, lateCount, catchupCount, createdAt, updatedAt);
    }

    public BatchDayInstanceRecord withReopened(Instant updatedAt) {
        return new BatchDayInstanceRecord(id, tenantId, calendarCode, bizDate, "IN_FLIGHT", openAt,
                cutoffAt, null, slaDeadlineAt, lateCount, catchupCount, createdAt, updatedAt);
    }
}
