 ...
 * default_params 自带 {taskType:sql, sql:'SELECT 1'},故 launch params 留空即可),且 batch-worker-spi
 ...
 * <p>Run:
 * <pre>
 *   mvn gatling:test -Dsimulation=SpiTaskDispatchSimulation \
 *       -DjobCode=spi_sql_demo -DtenantId=default-tenant \
 *       -Dusers.peak=50 -Dduration.seconds=180
 * </pre>
 */
public class SpiTaskDispatchSimulation extends Simulation {
