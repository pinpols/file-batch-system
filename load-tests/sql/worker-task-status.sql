...
WHERE instance.tenant_id = :'tenant_id' AND coalesce(instance.params_snapshot #>> '{requestParams,metadata,runId}', instance.params_snapshot #>> '{effectiveParams,metadata,runId}', instance.params_snapshot #>> '{metadata,runId}', instance.params_snapshot #>> '{runId}') = :'run_id'
