...
WHERE tenant_id = :'tenant_id'
  ...
  AND coalesce(params_snapshot #>> '{requestParams,metadata,stressUsers}', params_snapshot #>> '{effectiveParams,metadata,stressUsers}', params_snapshot #>> '{metadata,stressUsers}', params_snapshot #>> '{stressUsers}') = :'stress_users';
