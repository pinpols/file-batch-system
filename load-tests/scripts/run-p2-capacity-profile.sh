...
CAPACITY_TRIGGER_API_MAX_CONCURRENCY="${CAPACITY_TRIGGER_API_MAX_CONCURRENCY:-32}"
CAPACITY_TRIGGER_PLATFORM_DB_POOL_SIZE="${CAPACITY_TRIGGER_PLATFORM_DB_POOL_SIZE:-40}"
CAPACITY_ATOMIC_TASK_CLIENT_BASE_URLS="${CAPACITY_ATOMIC_TASK_CLIENT_BASE_URLS:-http://orchestrator:18082}"
...
CAPACITY_EXPECT_RATE_LIMIT_CONFIGURATION_VERSION="${CAPACITY_EXPECT_RATE_LIMIT_CONFIGURATION_VERSION:-2}"
CAPACITY_EXPECT_CLAIM_RATE_LIMIT_PER_MINUTE="${CAPACITY_EXPECT_CLAIM_RATE_LIMIT_PER_MINUTE:-12000}"
CAPACITY_EXPECT_REPORT_RATE_LIMIT_PER_MINUTE="${CAPACITY_EXPECT_REPORT_RATE_LIMIT_PER_MINUTE:-30000}"
