...
class ConsoleAdminTestDataControllerTest {
  ...
  void setUp() {
    ...
    when(jdbc.update(anyString(), org.mockito.ArgumentMatchers.any(MapSqlParameterSource.class)))
        .thenReturn(0);
  ...
  void shouldRejectBlankPrefixAtMethodGuard() throws Exception {
    ...
    verify(jdbc, never())
        .update(anyString(), org.mockito.ArgumentMatchers.any(MapSqlParameterSource.class));
  }
  ...
  void shouldRunFullFkDeletionChainOnValidPrefix() throws Exception {
    ...
    verify(jdbc, org.mockito.Mockito.atLeast(14))
        .update(anyString(), org.mockito.ArgumentMatchers.any(MapSqlParameterSource.class));
  }
