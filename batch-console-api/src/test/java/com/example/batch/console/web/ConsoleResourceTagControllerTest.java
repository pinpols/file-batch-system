...
class ConsoleResourceTagControllerTest {
    ...
    private final ConsoleResourceTagService tagService = org.mockito.Mockito.mock(ConsoleResourceTagService.class);
    ...
    void setUp() {
        ...
        mockMvc = MockMvcBuilders.standaloneSetup(new ConsoleResourceTagController(tagService, responseFactory, requestMetadataResolver))
    ...
    void shouldListTagsByResource() throws Exception {
        ...
        mockMvc.perform(get("/api/console/tags")
                        .param("tenantId", "t1")
    ...
    void shouldSearchByTag() throws Exception {
        ...
        mockMvc.perform(get("/api/console/tags/search")
                        .param("tenantId", "t1")
                        .param("tagKey", "env")
                        .param("tagValue", "prod"))
                .andExpect(status().isOk())
    ...
    void shouldUpsertTag() throws Exception {
        mockMvc.perform(post("/api/console/tags")
                        .param("tenantId", "t1")
    ...
    void shouldDeleteTag() throws Exception {
        mockMvc.perform(delete("/api/console/tags")
                        .param("tenantId", "t1")
                        .param("resourceType", "JOB")
                        .param("resourceCode", "job-001")
                        .param("tagKey", "env"))
