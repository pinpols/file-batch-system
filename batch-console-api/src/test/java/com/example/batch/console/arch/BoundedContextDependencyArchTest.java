 ...
 *
 * <p>核心规则:{@code com.example.batch.console.domain.<ctx>.*} 内的类禁止直接 import {@code
 * com.example.batch.console.domain.<other-ctx>.*} 下的类。
 *
 * <p>允许的跨 context 通信方式(详见 docs/architecture/bounded-context-rules.md):
 *
 * <ul>
 *   <li>引用 {@code com.example.batch.console.shared.*}(共享 DTO / Entity / 工具)
...
class BoundedContextDependencyArchTest {
  ...
  /** 9 个有界上下文的子包名,对应 {@code com.example.batch.console.domain.<ctx>}. */
  static final String[] BOUNDED_CONTEXTS = {
    "job", "workflow", "file", "ops", "governance", "notification", "audit", "rbac", "observability"
  };

  static final String DOMAIN_ROOT = "com.example.batch.console.domain";
  static final String SHARED_ROOT = "com.example.batch.console.shared";
