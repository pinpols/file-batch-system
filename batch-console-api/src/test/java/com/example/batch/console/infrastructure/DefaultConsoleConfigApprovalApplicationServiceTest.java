...
class DefaultConsoleConfigApprovalApplicationServiceTest {
    ...
    void shouldApproveAndPublishRelease() {
        ...
        when(configApprovalMapper.selectById("t1", 9L)).thenReturn(Map.of(
                "id", 9L,
                "releaseId", 10L,
        ...
        when(configApprovalMapper.selectLatestByRelease("t1", 10L)).thenReturn(Map.of("approvalStatus", "APPROVED"));
