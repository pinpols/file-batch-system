...
class ConsoleApprovalControllerTest {
    ...
    private final ConsoleApprovalApplicationService approvalApplicationService = org.mockito.Mockito.mock(ConsoleApprovalApplicationService.class);
    ...
    void setUp() {
        ...
        mockMvc = MockMvcBuilders.standaloneSetup(new ConsoleApprovalController(approvalApplicationService, responseFactory))
    ...
    void shouldReturn400WhenIdempotencyHeaderMissing() throws Exception {
        mockMvc.perform(post("/api/console/approvals/appr-001/approve")
    ...
    void shouldApproveAndReturnCommonResponseOnSuccess() throws Exception {
        when(approvalApplicationService.approve(anyString(), anyString(), anyString(), anyString())).thenReturn("OK");
    ...
    void shouldReturn400WhenRequestBodyInvalid() throws Exception {
        mockMvc.perform(post("/api/console/approvals/appr-001/reject")
