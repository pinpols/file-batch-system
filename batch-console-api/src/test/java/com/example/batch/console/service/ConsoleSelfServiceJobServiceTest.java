...
class ConsoleSelfServiceJobServiceTest {
    ...
    void setUp() {
        ...
        service = new ConsoleSelfServiceJobService(restClientBuilder, orchestratorClientProperties, tenantGuard, environment);
    }
    ...
    void shouldSubmitCompensationApproval() {
        ...
        CompensationParam param = new CompensationParam("tenant-a", "JOB-02", "2026-04-10", "FULL", "INST-002", "test compensation");
