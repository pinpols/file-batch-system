...
class ConsoleAiControllerTest {
    ...
    private final ConsoleAiApplicationService applicationService = org.mockito.Mockito.mock(ConsoleAiApplicationService.class);
    ...
    void setUp() {
        ...
        mockMvc = MockMvcBuilders.standaloneSetup(new ConsoleAiController(applicationService, responseFactory))
    ...
    void shouldReturn400WhenIdempotencyHeaderMissing() throws Exception {
        mockMvc.perform(post("/api/console/ai/chat")
