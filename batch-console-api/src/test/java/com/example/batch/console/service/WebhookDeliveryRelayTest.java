  ...
  void setUp() throws Throwable {
    ...
    relay =
        new WebhookDeliveryRelay(
            deliveryLogRepository, subscriptionRepository, dispatcher, lockExecutor, meterRegistry);
    // 默认 batchSize=50, absoluteMaxAttempts=8 (与 @Value 默认一致)
    ReflectionTestUtils.setField(relay, "batchSize", 50);
    ReflectionTestUtils.setField(relay, "absoluteMaxAttempts", 8);
  }
