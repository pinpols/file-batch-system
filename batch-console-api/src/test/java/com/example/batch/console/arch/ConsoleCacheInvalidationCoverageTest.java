 ...
 * com.example.batch.console.infrastructure.config.ConsoleConfigCacheInvalidationService} 的某个 evict*
 * 方法，否则 orchestrator 在 launch 热路径上读到的 Redis 配置缓存会留陈旧值。
 *
...
class ConsoleCacheInvalidationCoverageTest {
  ...
  private static final Set<String> CACHED_SERVICE_FQNS =
      Set.of(
          "com.example.batch.console.domain.job.infrastructure.DefaultConsoleJobDefinitionApplicationService",
          "com.example.batch.console.infrastructure.workflow.DefaultConsoleWorkflowDefinitionApplicationService",
          "com.example.batch.console.domain.job.infrastructure.DefaultConsoleCalendarApplicationService",
          "com.example.batch.console.domain.job.infrastructure.DefaultConsoleBatchWindowApplicationService",
          "com.example.batch.console.infrastructure.config.DefaultConsoleQuotaPolicyApplicationService");
  ...
  private static final Set<String> EXEMPTIONS =
      Set.of(
          ...
          "com.example.batch.console.infrastructure.workflow.DefaultConsoleWorkflowDefinitionApplicationService#upsertNodesAndEdges",
          ...
          "com.example.batch.console.infrastructure.workflow.DefaultConsoleWorkflowDefinitionApplicationService#appendVersionSnapshot");
