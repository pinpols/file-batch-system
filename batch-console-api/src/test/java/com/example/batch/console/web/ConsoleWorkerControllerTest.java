...
class ConsoleWorkerControllerTest {
    ...
    private final ConsoleWorkerApplicationService applicationService = org.mockito.Mockito.mock(ConsoleWorkerApplicationService.class);
    ...
    void setUp() {
        ...
        mockMvc = MockMvcBuilders.standaloneSetup(new ConsoleWorkerController(applicationService, responseFactory))
