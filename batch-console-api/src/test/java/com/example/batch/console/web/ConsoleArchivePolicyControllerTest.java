...
class ConsoleArchivePolicyControllerTest {
    ...
    private final ConsoleArchivePolicyService archivePolicyService = org.mockito.Mockito.mock(ConsoleArchivePolicyService.class);
    ...
    void setUp() {
        ...
        mockMvc = MockMvcBuilders.standaloneSetup(new ConsoleArchivePolicyController(archivePolicyService, responseFactory, requestMetadataResolver))
    ...
    void shouldListPolicies() throws Exception {
        ...
        mockMvc.perform(get("/api/console/ops/archive-policies").param("tenantId", "t1"))
    ...
    void shouldUpsertPolicy() throws Exception {
        mockMvc.perform(put("/api/console/ops/archive-policies")
                        .param("tenantId", "t1")
        ...
        verify(archivePolicyService).upsert("t1", "job_instance", 90, true, false, 1000, "Archive job instances", "operator-1");
    }
}
