...
public class ConsoleSecurityProperties implements EnvironmentAware {
  ...
  /**
   * 默认授权角色（SSE ticket 空角色 / bypass-mode 未带 role header 时的回退）。
   *
   ...
   * {@code role-header}，不能再依赖隐式 admin 回退。
   */
   ...
   * {@link io.github.pinpols.batch.console.domain.rbac.support.ConsoleLoginService}。
   *
   * <p>双模式 + prod 守护:
   *
   * <ul>
