...
import io.github.pinpols.batch.console.domain.rbac.web.request.CreateUserAccountRequest;
import io.github.pinpols.batch.console.domain.rbac.web.request.ResetPasswordRequest;
import io.github.pinpols.batch.console.domain.rbac.web.request.UpdateUserAccountRequest;
 ...
 * io.github.pinpols.batch.console.domain.rbac.service.ConsoleUserAccountService} 在 Service 层强制注入
 * tenantId / 拒绝越权 / 拒绝授 ADMIN-AUDITOR 等管控,粗筛只是把无关角色挡在门外。
 */
@RestController
@Validated
