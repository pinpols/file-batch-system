...
import io.github.pinpols.batch.console.application.rbac.ConsoleTenantApplicationService.BatchCreateTenantCommand;
import io.github.pinpols.batch.console.application.rbac.ConsoleTenantApplicationService.ConfigInitOption;
import io.github.pinpols.batch.console.application.rbac.ConsoleTenantApplicationService.CreateTenantCommand;
import io.github.pinpols.batch.console.application.rbac.ConsoleTenantApplicationService.TenantSpec;
import io.github.pinpols.batch.console.application.rbac.ConsoleTenantReadinessService;
import io.github.pinpols.batch.console.domain.rbac.application.contract.request.BatchCreateTenantRequest;
import io.github.pinpols.batch.console.domain.rbac.application.contract.request.CreateTenantRequest;
import io.github.pinpols.batch.console.domain.rbac.application.contract.request.UpdateTenantRequest;
import io.github.pinpols.batch.console.domain.rbac.application.contract.response.BatchCreateTenantsResponse;
