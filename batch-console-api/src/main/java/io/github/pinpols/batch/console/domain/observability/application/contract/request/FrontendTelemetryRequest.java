package io.github.pinpols.batch.console.domain.observability.application.contract.request;
...
/**
 * P2-2(2026-05-16):增加 userId / sessionId / ts / page / props 的大小约束, 避免登录用户用大 payload 写满
