 ...
 *
 * <p>故意只保留 SELECT — docs/agent-baseline.md「Orchestrator 是唯一状态主机」硬约束下，console 不能直接 UPDATE/DELETE
 * outbox_event；cleanup / republish 等运维操作由 ConsoleOrchestratorPort 转发到 orchestrator
