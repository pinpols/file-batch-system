 ...
 * io.github.pinpols.batch.console.support.maintenance.MaintenanceStateHolder} 的 AtomicReference;
 * admin 通过 PUT {@code /api/console/admin/system/maintenance} 热更新,无须重启。
 *
