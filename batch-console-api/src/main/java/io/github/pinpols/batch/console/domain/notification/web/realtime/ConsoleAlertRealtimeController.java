package io.github.pinpols.batch.console.domain.notification.web.realtime;
...
public class ConsoleAlertRealtimeController {
  ...
  public SseEmitter events(
    ...
    return realtimeEventHub.subscribe(
        tenantGuard.resolveTenant(tenantId), "alerts", eventType, cursor, heartbeatMillis);
  }
}
