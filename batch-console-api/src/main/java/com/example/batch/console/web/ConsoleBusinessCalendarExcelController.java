...
public class ConsoleBusinessCalendarExcelController {
    ...
    public CommonResponse<ConsoleBusinessCalendarExcelUploadResponse> upload(@RequestParam("file") MultipartFile file) throws IOException {
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_ADMIN', 'ROLE_CONFIG_ADMIN')")
    public CommonResponse<ConsoleBusinessCalendarExcelPreviewResponse> preview(@PathVariable String uploadToken) {
    ...
    public CommonResponse<ConsoleBusinessCalendarExcelApplyResponse> apply(@RequestHeader(CommonConstants.DEFAULT_IDEMPOTENCY_KEY_HEADER) String idempotencyKey,
