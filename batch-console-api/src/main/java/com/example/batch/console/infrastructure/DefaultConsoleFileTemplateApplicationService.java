...
public class DefaultConsoleFileTemplateApplicationService implements ConsoleFileTemplateApplicationService {
    ...
    public Map<String, Object> create(FileTemplateCreateRequest request) {
        ...
        Map<String, Object> existing = mapper.selectByUniqueKey(tenantId, request.getTemplateCode(), version);
        if (existing != null) {
    ...
    public Map<String, Object> update(Long id, FileTemplateUpdateRequest request) {
        ...
        int version = request.getVersion() != null ? request.getVersion()
                : existing.get("version") != null ? ((Number) existing.get("version")).intValue() : 1;
        mapper.upsertFileTemplateConfig(buildUpdateParam(tenantId, templateCode, version, operator, request, existing));
    ...
    private FileTemplateConfigUpsertParam buildCreateParam(String tenantId,
                                                           int version,
                                                           String operator,
                                                           FileTemplateCreateRequest request) {
    ...
    private FileTemplateConfigUpsertParam buildUpdateParam(String tenantId,
                                                           String templateCode,
                                                           int version,
                                                           String operator,
        ...
        param.setBasicInfo(basicInfo(
                request.getTemplateName() != null ? request.getTemplateName() : (String) existing.get("template_name"),
                request.getTemplateType() != null ? request.getTemplateType() : (String) existing.get("template_type"),
                ...
                version,
                request.getDescription() != null ? request.getDescription() : (String) existing.get("description")
        ));
        FileTemplateConfigUpsertParam.FormatOptions format = new FileTemplateConfigUpsertParam.FormatOptions();
        format.setFileFormatType(request.getFileFormatType() != null ? request.getFileFormatType() : (String) existing.get("file_format_type"));
        format.setCharset(request.getCharset() != null ? request.getCharset() : (String) existing.get("charset"));
        format.setTargetCharset(request.getTargetCharset() != null ? request.getTargetCharset() : (String) existing.get("target_charset"));
        format.setWithBom(request.getWithBom() != null ? request.getWithBom() : (Boolean) existing.get("with_bom"));
        format.setLineSeparator(request.getLineSeparator() != null ? request.getLineSeparator() : (String) existing.get("line_separator"));
        format.setDelimiter(request.getDelimiter() != null ? request.getDelimiter() : (String) existing.get("delimiter"));
        format.setQuoteChar(request.getQuoteChar() != null ? request.getQuoteChar() : (String) existing.get("quote_char"));
        format.setEscapeChar(request.getEscapeChar() != null ? request.getEscapeChar() : (String) existing.get("escape_char"));
        format.setRecordLength(request.getRecordLength() != null ? request.getRecordLength() : intValue(existing.get("record_length")));
        format.setHeaderRows(request.getHeaderRows() != null ? request.getHeaderRows() : intValue(existing.get("header_rows")));
        format.setFooterRows(request.getFooterRows() != null ? request.getFooterRows() : intValue(existing.get("footer_rows")));
        format.setHeaderTemplateJson(request.getHeaderTemplateJson() != null ? request.getHeaderTemplateJson() : stringValue(existing.get("header_template")));
        format.setTrailerTemplateJson(request.getTrailerTemplateJson() != null ? request.getTrailerTemplateJson() : stringValue(existing.get("trailer_template")));
        format.setChecksumType(request.getChecksumType() != null ? request.getChecksumType() : (String) existing.get("checksum_type"));
        format.setCompressType(request.getCompressType() != null ? request.getCompressType() : (String) existing.get("compress_type"));
        format.setEncryptType(request.getEncryptType() != null ? request.getEncryptType() : (String) existing.get("encrypt_type"));
        format.setNamingRule(request.getNamingRule() != null ? request.getNamingRule() : (String) existing.get("naming_rule"));
        format.setFieldMappingsJson(request.getFieldMappingsJson() != null ? request.getFieldMappingsJson() : stringValue(existing.get("field_mappings")));
        format.setValidationRuleSetJson(request.getValidationRuleSetJson() != null ? request.getValidationRuleSetJson() : stringValue(existing.get("validation_rule_set")));
        param.setFormat(format);
        param.setQuery(queryOptions(
                request.getDefaultQueryCode() != null ? request.getDefaultQueryCode() : (String) existing.get("default_query_code"),
                request.getDefaultQuerySql() != null ? request.getDefaultQuerySql() : (String) existing.get("default_query_sql"),
                request.getQueryParamSchemaJson() != null ? request.getQueryParamSchemaJson() : stringValue(existing.get("query_param_schema"))
        ));
        param.setRuntime(runtimeOptions(
                request.getStreamingEnabled() != null ? request.getStreamingEnabled() : (Boolean) existing.get("streaming_enabled"),
                request.getPageSize() != null ? request.getPageSize() : intValue(existing.get("page_size")),
        ...
        param.setSecurity(securityOptions(new SecurityOptionsInput(
                ...
                request.getContentEncryptionEnabled() != null ? request.getContentEncryptionEnabled() : (Boolean) existing.get("content_encryption_enabled"),
    ...
    private FileTemplateConfigUpsertParam.BasicInfo basicInfo(String templateName,
                                                              String templateType,
                                                              String bizType,
                                                              Boolean enabled,
                                                              Integer version,
    ...
    private FileTemplateConfigUpsertParam.QueryOptions queryOptions(String defaultQueryCode,
    ...
    private FileTemplateConfigUpsertParam.RuntimeOptions runtimeOptions(Boolean streamingEnabled,
                                                                        Integer pageSize,
                                                                        Integer fetchSize,
                                                                        Integer chunkSize) {
    ...
    private FileTemplateConfigUpsertParam.AuditOptions auditOptions(String createdBy, String updatedBy) {
