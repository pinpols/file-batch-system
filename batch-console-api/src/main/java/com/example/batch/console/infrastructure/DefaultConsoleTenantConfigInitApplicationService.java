...
public class DefaultConsoleTenantConfigInitApplicationService
  ...
  protected TenantInitResult initForTenant(
    ...
    try {
      ...
      ItemStats workflowStats = applyWorkflowDefinitions(request.getWorkflowDefinitions(), ctx);
      ItemStats pipelineStats = applyPipelineDefinitions(request.getPipelineDefinitions(), ctx);
