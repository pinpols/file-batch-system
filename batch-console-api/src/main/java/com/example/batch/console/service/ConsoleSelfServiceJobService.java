...
public class ConsoleSelfServiceJobService {
    ...
    public String requestRerun(RerunParam param, String operator, String idempotencyKey) {
        ...
        return submitApproval(tenantId, "RERUN", "JOB_INSTANCE", param.jobCode(),
                JsonUtils.toJson(payload), operator, idempotencyKey);
    }

    public String requestCompensation(CompensationParam param, String operator, String idempotencyKey) {
        String tenantId = tenantGuard.resolveTenant(param.tenantId());
        Map<String, Object> payload = new LinkedHashMap<>();
        payload.put("tenantId", tenantId);
        payload.put("jobCode", param.jobCode());
        ...
        payload.put("targetInstanceNo", param.targetInstanceNo());
        payload.put("reason", param.reason());
        return submitApproval(tenantId, "COMPENSATION", "JOB_INSTANCE", param.jobCode(),
                JsonUtils.toJson(payload), operator, idempotencyKey);
    }

    @SuppressWarnings("unchecked")
    private String submitApproval(String tenantId, String actionType, String targetType,
                                  String targetId, String payloadJson, String operator,
    ...
    public record RerunParam(String tenantId, String jobCode, String bizDate,
                             String targetInstanceNo, String reason) {
    }

    public record CompensationParam(String tenantId, String jobCode, String bizDate,
                                    String compensationType, String targetInstanceNo, String reason) {
    }
}
