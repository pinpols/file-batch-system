...
public class DefaultConsoleNotificationApplicationService
    ...
    public void createChannel(String tenantId, Map<String, Object> params) {
        ...
        if (channelMapper.selectByCode(resolved, channelCode) != null) {
            throw new BizException(
                    ResultCode.CONFLICT, "channel code already exists: " + channelCode);
        }
    ...
    public Map<String, Object> getRule(String tenantId, Long ruleId) {
        ...
        Map<String, Object> rule =
                Guard.requireFound(
                        ruleMapper.selectById(resolved, ruleId),
                        "subscription rule not found: " + ruleId);
        return rule;
    }
    ...
    public void createRule(String tenantId, Map<String, Object> params) {
        ...
        ruleMapper.insert(
                mapOf(
                        ...
                        "channelCode", channelCode,
                        "eventTypes",
                                ConsoleTextSanitizer.safeInput(str(params, "eventTypes"), 512),
                        "severityFilter",
                                ConsoleTextSanitizer.safeInput(str(params, "severityFilter"), 128),
                        "jobCodeFilter",
                                ConsoleTextSanitizer.safeInput(str(params, "jobCodeFilter"), 512),
                        "enabled", params.getOrDefault("enabled", true),
                        "createdBy", operator,
                        "updatedBy", operator));
    }
