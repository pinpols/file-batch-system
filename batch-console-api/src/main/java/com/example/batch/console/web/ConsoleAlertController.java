...
public class ConsoleAlertController {
    ...
    public CommonResponse<ConsoleAlertActionResponse> ack(@RequestHeader(CommonConstants.DEFAULT_IDEMPOTENCY_KEY_HEADER) String idempotencyKey,
    ...
    public CommonResponse<ConsoleAlertActionResponse> silence(@RequestHeader(CommonConstants.DEFAULT_IDEMPOTENCY_KEY_HEADER) String idempotencyKey,
                                                              @PathVariable Long alertId,
                                                              @Valid @RequestBody AlertActionRequest request) {
    ...
    public CommonResponse<ConsoleAlertActionResponse> close(@RequestHeader(CommonConstants.DEFAULT_IDEMPOTENCY_KEY_HEADER) String idempotencyKey,
                                                            @PathVariable Long alertId,
                                                            @Valid @RequestBody AlertActionRequest request) {
