...
public class ConsoleReportExcelController {
  ...
  public ResponseEntity<InputStreamResource> configReleases(
  ...
  /** 导出密钥版本 Excel。 */
  @GetMapping("/secrets")
  public ResponseEntity<InputStreamResource> secrets(
  ...
  public ResponseEntity<InputStreamResource> configChangeLogs(
  ...
  public ResponseEntity<InputStreamResource> schedulerSnapshot(
  ...
  public ResponseEntity<InputStreamResource> schedulerHistory(
      @RequestParam("tenantId") String tenantId,
  ...
  /** 导出 Worker 列表 Excel。 */
  @GetMapping("/workers")
  public ResponseEntity<InputStreamResource> workers(
  ...
  public ResponseEntity<InputStreamResource> outboxRetries(
  ...
  public ResponseEntity<InputStreamResource> outboxDeliveries(
