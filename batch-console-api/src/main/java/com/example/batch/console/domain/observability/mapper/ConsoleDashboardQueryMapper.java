package com.example.batch.console.domain.observability.mapper;

import com.example.batch.console.domain.observability.view.dashboard.ActivePartitionView;
import com.example.batch.console.domain.observability.view.dashboard.ConfigDependentView;
import com.example.batch.console.domain.observability.view.dashboard.DayCountView;
import com.example.batch.console.domain.observability.view.dashboard.DaySeverityCountView;
import com.example.batch.console.domain.observability.view.dashboard.DayStatusCountView;
import com.example.batch.console.domain.observability.view.dashboard.ExecutionProgressView;
import com.example.batch.console.domain.observability.view.dashboard.SeverityCountView;
import com.example.batch.console.domain.observability.view.dashboard.SlaDayView;
import com.example.batch.console.domain.observability.view.dashboard.SlaJobReportView;
...
import com.example.batch.console.domain.observability.view.dashboard.TypeCountView;
import com.example.batch.console.domain.observability.view.dashboard.WorkerGroupStatusCountView;
