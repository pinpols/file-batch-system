...
public class DefaultConsoleBatchWindowApplicationService
    ...
    public Map<String, Object> create(BatchWindowCreateRequest request) {
        ...
        params.put(
                "allow_cross_day",
                request.getAllowCrossDay() != null ? request.getAllowCrossDay() : false);
    ...
    public Map<String, Object> update(Long id, BatchWindowUpdateRequest request) {
        ...
        Map<String, Object> existing =
                Guard.requireFound(
                        batchWindowMapper.selectById(tenantId, id), "batch window not found");
        Map<String, Object> params = new HashMap<>();
        params.put("tenant_id", tenantId);
        params.put("id", id);
        params.put(
                "window_name",
                request.getWindowName() != null
                        ? request.getWindowName()
                        : existing.get("window_name"));
        params.put(
                "timezone",
        ...
        params.put(
                "end_strategy",
                request.getEndStrategy() != null
                        ? request.getEndStrategy()
                        : existing.get("end_strategy"));
        params.put(
                "out_of_window_action",
