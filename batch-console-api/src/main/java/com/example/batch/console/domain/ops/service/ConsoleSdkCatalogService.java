...
import com.example.batch.console.domain.ops.dto.SdkCatalog.ProtocolVersion;
import com.example.batch.console.domain.ops.dto.SdkCatalog.SdkDoc;
import com.example.batch.console.domain.ops.dto.SdkCatalog.SdkLanguage;
...
public class ConsoleSdkCatalogService {
  ...
  private static final List<SdkLanguage> LANGUAGES =
      List.of(
          new SdkLanguage(
              "java",
              "com.example.batch:batch-worker-sdk",
              "1.1.0-SNAPSHOT",
              "<dependency>\n"
