...
public class DefaultConsoleResourceQueueApplicationService
    ...
    public PageResponse<Map<String, Object>> list(
        ...
        List<Map<String, Object>> items =
                resourceQueueMapper.selectByQuery(
                        resolved, queueCode, queueType, enabled, pageRequest);
    ...
    public Map<String, Object> create(ResourceQueueCreateRequest request) {
        ...
        params.put(
                "max_running_jobs",
                request.getMaxRunningJobs() != null ? request.getMaxRunningJobs() : 0);
        params.put(
    ...
    public Map<String, Object> update(Long id, ResourceQueueUpdateRequest request) {
        ...
        params.put(
                ...
                request.getQueueName() != null
                        ...
                        : existing.get("queue_name"));
        params.put(
                "queue_type",
                request.getQueueType() != null
                        ? request.getQueueType()
                        : existing.get("queue_type"));
        params.put(
                "max_running_jobs",
        ...
        params.put(
                "max_qps",
                request.getMaxQps() != null ? request.getMaxQps() : existing.get("max_qps"));
        params.put(
                "worker_group",
        ...
        params.put(
                "resource_tag",
                request.getResourceTag() != null
                        ? request.getResourceTag()
                        : existing.get("resource_tag"));
        params.put(
                "priority_policy",
