...
public class ConsoleQuotaPolicyController {
    ...
    public CommonResponse<PageResponse<Map<String, Object>>> list(
        ...
        return responseFactory.success(quotaPolicyApplicationService.list(tenantId, policyCode, enabled, pageNo, pageSize));
    }

    @PostMapping
    public CommonResponse<Map<String, Object>> create(@Valid @RequestBody QuotaPolicySaveRequest request) {
