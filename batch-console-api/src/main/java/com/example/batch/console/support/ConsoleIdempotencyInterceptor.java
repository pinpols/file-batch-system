...
public class ConsoleIdempotencyInterceptor implements HandlerInterceptor {
    ...
    private static final String CONFLICT_BODY =
            "{\"code\":\"" + ResultCode.CONFLICT.code() + "\",\"message\":\"duplicate request, same Idempotency-Key already processed\"}";
    ...
    public boolean preHandle(
        ...
        if (Boolean.FALSE.equals(isNew)) {
            log.warn("duplicate idempotency key rejected: key={}, uri={}", idempotencyKey, request.getRequestURI());
