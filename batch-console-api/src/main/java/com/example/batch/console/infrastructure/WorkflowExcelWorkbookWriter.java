...
import static com.example.batch.console.infrastructure.WorkflowExcelColumnMetadata.DEF_COLUMN_GUIDES;
...
import static com.example.batch.console.infrastructure.WorkflowExcelColumnMetadata.EDGE_COLUMN_GUIDES;
import static com.example.batch.console.infrastructure.WorkflowExcelColumnMetadata.EDGE_SHEET;
import static com.example.batch.console.infrastructure.WorkflowExcelColumnMetadata.EDGE_SUCCESS;
...
import static com.example.batch.console.infrastructure.WorkflowExcelColumnMetadata.NODE_COLUMN_GUIDES;
...
class WorkflowExcelWorkbookWriter {
  ...
  byte[] writeMaintenanceWorkbook(String tenantId, List<WorkflowDefinitionEntity> definitions) {
