...
public class ConsoleBatchWindowController {
    ...
    public CommonResponse<PageResponse<Map<String, Object>>> list(
        ...
        return responseFactory.success(batchWindowApplicationService.list(tenantId, windowCode, enabled, pageNo, pageSize));
    }

    @PostMapping
    public CommonResponse<Map<String, Object>> create(@Valid @RequestBody BatchWindowCreateRequest request) {
    ...
    public CommonResponse<Map<String, Object>> update(@PathVariable Long id,
                                                       @Valid @RequestBody BatchWindowUpdateRequest request) {
