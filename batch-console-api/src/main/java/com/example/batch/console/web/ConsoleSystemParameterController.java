...
public class ConsoleSystemParameterController {
    ...
    @GetMapping
    public CommonResponse<List<SystemParameterEntity>> list(@RequestParam("tenantId") String tenantId) {
        return responseFactory.success(parameterService.list(tenantId));
    }

    @GetMapping("/value")
    public CommonResponse<Map<String, String>> getValue(@RequestParam("tenantId") String tenantId,
                                                        @RequestParam("key") @NotBlank String key) {
        return responseFactory.success(
                parameterService.getValue(tenantId, key)
    ...
    public CommonResponse<Void> upsert(@RequestParam("tenantId") String tenantId,
                                       @RequestBody @Validated UpsertParam param) {
