 ...
 *
 * <p>所有字段 package-private,只对同包 console.infrastructure 可见。
 */
final class WorkflowExcelColumnMetadata {

  private WorkflowExcelColumnMetadata() {}

  // ── sheet 名 ──────────────────────────────────────────────────────────────
  static final String DEF_SHEET = "workflow_definition";
  static final String NODE_SHEET = "workflow_node";
  static final String EDGE_SHEET = "workflow_edge";
  ...
  static final String EDGE_SUCCESS = "SUCCESS";
  static final String GUIDE_STR = "字符串";
  static final String GUIDE_TRUE = "TRUE";
  static final String GUIDE_INT = "整数";
  static final String GUIDE_FALSE = "FALSE";

  // ── 列顺序 ────────────────────────────────────────────────────────────────
  static final List<String> DEF_COLUMNS =
      List.of(
          COL_TENANT_ID,
          COL_WORKFLOW_CODE,
          "workflow_name",
          ...
          COL_ENABLED,
          COL_DESCRIPTION);
  static final List<String> NODE_COLUMNS =
      List.of(
          COL_TENANT_ID,
          COL_WORKFLOW_CODE,
  ...
  static final Set<String> DEF_HEADERS = Set.copyOf(DEF_COLUMNS);
  static final Set<String> NODE_HEADERS = Set.copyOf(NODE_COLUMNS);
  static final Set<String> EDGE_HEADERS = Set.copyOf(EDGE_COLUMNS);

  // ── 列说明(导出 Excel 时写入说明 sheet/批注) ──────────────────────────────
  static final Map<String, ConsoleExcelStyles.ColumnGuide> DEF_COLUMN_GUIDES =
      Map.ofEntries(
          Map.entry(
  ...
  static final Map<String, ConsoleExcelStyles.ColumnGuide> NODE_COLUMN_GUIDES =
      Map.ofEntries(
          Map.entry(
              COL_TENANT_ID, optionalColumn("当前行所属租户。留空时，上传时自动使用当前租户。", GUIDE_STR, "tenant-a")),
          Map.entry(
  ...
  static final Map<String, ConsoleExcelStyles.ColumnGuide> EDGE_COLUMN_GUIDES =
      Map.ofEntries(
          Map.entry(
              COL_TENANT_ID, optionalColumn("当前行所属租户。留空时，上传时自动使用当前租户。", GUIDE_STR, "tenant-a")),
          Map.entry(
