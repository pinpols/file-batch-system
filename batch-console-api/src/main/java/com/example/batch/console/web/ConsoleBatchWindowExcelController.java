...
public class ConsoleBatchWindowExcelController {
    ...
    public CommonResponse<ConsoleBatchWindowExcelUploadResponse> upload(@RequestParam("file") MultipartFile file) throws IOException {
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_ADMIN', 'ROLE_CONFIG_ADMIN')")
    public CommonResponse<ConsoleBatchWindowExcelPreviewResponse> preview(@PathVariable String uploadToken) {
    ...
    public CommonResponse<ConsoleBatchWindowExcelApplyResponse> apply(@RequestHeader(CommonConstants.DEFAULT_IDEMPOTENCY_KEY_HEADER) String idempotencyKey,
