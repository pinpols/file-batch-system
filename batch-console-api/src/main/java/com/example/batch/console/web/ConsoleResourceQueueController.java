...
public class ConsoleResourceQueueController {
    ...
    public CommonResponse<PageResponse<Map<String, Object>>> list(
        ...
        return responseFactory.success(resourceQueueApplicationService.list(tenantId, queueCode, queueType, enabled, pageNo, pageSize));
    }

    @PostMapping
    public CommonResponse<Map<String, Object>> create(@Valid @RequestBody ResourceQueueCreateRequest request) {
    ...
    public CommonResponse<Map<String, Object>> update(@PathVariable Long id,
                                                       @Valid @RequestBody ResourceQueueUpdateRequest request) {
