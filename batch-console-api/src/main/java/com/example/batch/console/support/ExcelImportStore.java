 ...
 *
 * <p>替代各实体独立的 XxxExcelImportStore 接口（AlertRouting / BatchWindow / FileChannel /
 * FileTemplate / ResourceQueue / TenantQuotaPolicy 形态完全一致）。
 *
 * <p>复杂多 sheet 场景（BusinessCalendar / Pipeline / Workflow / TenantConfigPackage）保留各自的
 * Store 接口。
 */
