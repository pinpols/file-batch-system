...
public class DefaultConsoleJobDefinitionApplicationService
    ...
    public ConsoleJobDefinitionResponse detail(Long id, String tenantId) {
        ...
        JobDefinitionEntity entity =
                Guard.requireFound(
                        jobDefinitionMapper.selectById(resolvedTenant, id),
    ...
    public ConsoleJobDefinitionResponse update(Long id, JobDefinitionUpdateRequest request) {
        ...
        param.setJobName(
                request.getJobName() != null ? request.getJobName() : existing.getJobName());
        param.setQueueCode(
        ...
        param.setScheduleExpr(
                request.getScheduleExpr() != null
                        ? request.getScheduleExpr()
        ...
        param.setWindowCode(
                request.getWindowCode() != null
                        ? request.getWindowCode()
                        : existing.getWindowCode());
        param.setRetryPolicy(
                request.getRetryPolicy() != null
        ...
        param.setEnabled(
                request.getEnabled() != null ? request.getEnabled() : existing.getEnabled());
    ...
    @Override
    public ConsoleJobDefinitionResponse copyWithOverrides(
            Long id, JobDefinitionCopyRequest request) {
