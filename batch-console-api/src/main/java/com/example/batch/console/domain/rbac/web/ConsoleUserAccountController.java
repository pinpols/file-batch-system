...
import com.example.batch.console.domain.rbac.web.request.CreateUserAccountRequest;
import com.example.batch.console.domain.rbac.web.request.ResetPasswordRequest;
import com.example.batch.console.domain.rbac.web.request.UpdateUserAccountRequest;
import com.example.batch.console.domain.rbac.web.response.ConsoleUserAccountResponse;
 ...
 * com.example.batch.console.domain.rbac.service.ConsoleUserAccountService} 在 Service 层强制注入 tenantId
 * / 拒绝越权 / 拒绝授 ADMIN-AUDITOR 等管控,粗筛只是把无关角色挡在门外。
 */
@RestController
@Validated
