...
public class ConsoleTriggerController {
    ...
    public CommonResponse<Map<String, String>> register(@PathVariable String jobCode,
                                                         @RequestParam("tenantId") String tenantId) {
        return responseFactory.success(triggerProxyService.triggerAction(tenantId, jobCode, "register"));
    }

    @PostMapping("/{jobCode}/unregister")
    public CommonResponse<Map<String, String>> unregister(@PathVariable String jobCode,
                                                           @RequestParam("tenantId") String tenantId) {
        return responseFactory.success(triggerProxyService.triggerAction(tenantId, jobCode, "unregister"));
    }

    @PostMapping("/{jobCode}/pause")
    public CommonResponse<Map<String, String>> pause(@PathVariable String jobCode,
                                                      @RequestParam("tenantId") String tenantId) {
        return responseFactory.success(triggerProxyService.triggerAction(tenantId, jobCode, "pause"));
    }

    @PostMapping("/{jobCode}/resume")
    public CommonResponse<Map<String, String>> resume(@PathVariable String jobCode,
                                                       @RequestParam("tenantId") String tenantId) {
