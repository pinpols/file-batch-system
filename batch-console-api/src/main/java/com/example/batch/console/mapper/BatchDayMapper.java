...
public interface BatchDayMapper {
    ...
    Map<String, Object> selectWindow(@Param("tenantId") String tenantId,
                                     @Param("calendarCode") String calendarCode,
                                     @Param("bizDate") LocalDate bizDate);

    List<Map<String, Object>> selectJobSummaries(@Param("tenantId") String tenantId,
                                                 @Param("calendarCode") String calendarCode,
                                                 @Param("bizDate") LocalDate bizDate);

    List<String> selectFailedJobCodes(@Param("tenantId") String tenantId,
                                      @Param("calendarCode") String calendarCode,
                                      @Param("bizDate") LocalDate bizDate);
}
