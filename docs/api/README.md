...
当前契约以本目录 OpenAPI 和协议文档为准；2026-05-19 的一次性整理记录已归档到
[`../archive/analysis/frontend-backend-contract-cleanup-2026-05-19.md`](../archive/analysis/frontend-backend-contract-cleanup-2026-05-19.md)。
