...
v6 周期（57 项硬化条目）**已实质收口**。2026-06-15 重新核实代码/迁移/CI 后，v6 残留的多数 🟡 项已落地：
...
| 编号 | 主题 | 性质 | 触发 / 完成条件 |
|---|---|---|---|
| **V6-DBA-P1-1/P1-2** | `job_instance` / `workflow_run` 冗余索引 DROP | 🟡 加新已完成，DROP 待取证 | 需生产 `pg_stat_user_indexes.idx_scan` 数据证明旧索引零命中后，发 V14x `DROP INDEX`。流程见 [`runbook/index-consolidation-2026-05.md`](../runbook/index-consolidation-2026-05.md)（V142/V143 已加新索引 + 兜底 UNIQUE，无功能缺口，纯瘦身）|
