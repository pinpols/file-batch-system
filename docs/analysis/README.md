...
| 架构治理 | [面向抽象接口治理](./interface-abstraction-governance-2026-09-25.md)、[Redis / MQ 抽象治理](./redis-mq-abstraction-governance-2026-09-25.md)、[bounded context 计划](./bounded-context-migration-plan-2026-08-03.md)、[系统能力差距](./system-wide-capability-gap-analysis-2026-06-20.md)、[行业对标计划](./industry-benchmark-improvement-plan.md) |
