汇总（按严重度）
  ...
  ├─────────────────┼──────┼───────────────────────────────────────────────────────────────────────────┼───────────────────────────────────────────────────────────────────────────────────────────────────────────────────┤
  │                 │      │ DefaultWorkerSelector - worker selection returned no match:               │ 异常数据：某个 partition/job 异常退出 workerGroup=GENERAL + resourceTag=misc，但系统里根本没有这种 worker（都是         │
  ...
  7. 排查 1073 条 GENERAL/misc 异常数据：跑一条 SQL 找源头（哪个 job_definition / pending partition 定了这个 group/tag）
