...
INSERT INTO batch.job_task (
    ...
    (4201, 'default-tenant', 4001, 4101, 'EXECUTION', 1, 'RUNNING', 'import-node-1', jsonb_build_object('stage', 'parse'), NULL, NULL, NULL, TIMESTAMPTZ '2026-03-22 08:00:13+08', TIMESTAMPTZ '2026-03-22 08:00:13+08', TIMESTAMPTZ '2026-03-22 08:00:13+08'),
    ...
    (4205, 'tenant-finance', 4003, 4105, 'EXECUTION', 1, 'READY', 'export-node-1', jsonb_build_object('stage', 'workflow'), NULL, NULL, NULL, NULL, TIMESTAMPTZ '2026-03-22 08:00:33+08', TIMESTAMPTZ '2026-03-22 08:00:33+08'),
    (4206, 'tenant-finance', 4003, 4106, 'REPLAY', 1, 'CREATED', NULL, jsonb_build_object('stage', 'replay'), NULL, NULL, NULL, NULL, TIMESTAMPTZ '2026-03-22 08:00:34+08', TIMESTAMPTZ '2026-03-22 08:00:34+08');
...
INSERT INTO batch.file_channel_config (
    ...
    (5101, 'default-tenant', 'api_dispatch', 'API Dispatch', 'API', 'http://localhost:8090/api/dispatch', 'TOKEN', jsonb_build_object('target_endpoint', 'http://localhost:8090/api/dispatch', 'receipt_policy', 'SYNC', 'headers', jsonb_build_object('X-Tenant-Id', 'default-tenant')), 'SYNC', 30, TRUE, TIMESTAMPTZ '2026-03-22 08:00:00+08', TIMESTAMPTZ '2026-03-22 08:00:00+08'),
    (5102, 'default-tenant', 'api_push_dispatch', 'API Push Dispatch', 'API_PUSH', 'http://localhost:8090/api/push', 'TOKEN', jsonb_build_object('target_endpoint', 'http://localhost:8090/api/push', 'receipt_policy', 'ASYNC', 'api_push_api_key', 'demo-push-key', 'authorization', 'Bearer demo-token', 'receipt_poll_url', 'http://localhost:8090/api/push/receipt'), 'ASYNC', 30, TRUE, TIMESTAMPTZ '2026-03-22 08:00:00+08', TIMESTAMPTZ '2026-03-22 08:00:00+08'),
    (5103, 'default-tenant', 'local_dispatch', 'Local Dispatch', 'LOCAL', '/tmp/batch/local-dispatch', 'NONE', jsonb_build_object('target_endpoint', '/tmp/batch/local-dispatch', 'receipt_policy', 'NONE'), 'NONE', 10, TRUE, TIMESTAMPTZ '2026-03-22 08:00:00+08', TIMESTAMPTZ '2026-03-22 08:00:00+08'),
    (5104, 'default-tenant', 'nas_dispatch', 'NAS Dispatch', 'NAS', NULL, 'PASSWORD', jsonb_build_object('target_endpoint', '/mnt/nas/batch', 'nas_remote_directory', '/mnt/nas/batch', 'nas_remote_file_name', 'settlement.csv', 'receipt_policy', 'SYNC'), 'SYNC', 30, TRUE, TIMESTAMPTZ '2026-03-22 08:00:00+08', TIMESTAMPTZ '2026-03-22 08:00:00+08'),
    (5105, 'default-tenant', 'oss_dispatch', 'OSS Dispatch', 'OSS', NULL, 'TOKEN', jsonb_build_object('oss_bucket', 'batch-dev', 'oss_object_prefix', 'dispatch/', 'receipt_policy', 'POLLING', 'receipt_poll_url', 'http://localhost:9000/receipt'), 'POLLING', 30, TRUE, TIMESTAMPTZ '2026-03-22 08:00:00+08', TIMESTAMPTZ '2026-03-22 08:00:00+08'),
    (5106, 'default-tenant', 'sftp_dispatch', 'SFTP Dispatch', 'SFTP', 'sftp.example.com', 'PASSWORD', jsonb_build_object('sftp_host', 'sftp.example.com', 'sftp_port', 22, 'sftp_user', 'batch', 'sftp_password', 'batch-pass', 'sftp_remote_directory', '/inbox', 'sftp_remote_file_name', 'settlement.csv', 'receipt_policy', 'NONE'), 'NONE', 45, TRUE, TIMESTAMPTZ '2026-03-22 08:00:00+08', TIMESTAMPTZ '2026-03-22 08:00:00+08'),
    (5107, 'default-tenant', 'email_dispatch', 'Email Dispatch', 'EMAIL', 'ops@example.com', 'PASSWORD', jsonb_build_object('smtp_host', 'smtp.example.com', 'smtp_port', 587, 'smtp_username', 'batch@example.com', 'smtp_password', 'batch-pass', 'smtp_starttls', TRUE, 'mail_from', 'batch@example.com', 'mail_to', 'ops@example.com', 'mail_subject', 'Batch Dispatch', 'receipt_policy', 'SYNC'), 'SYNC', 45, TRUE, TIMESTAMPTZ '2026-03-22 08:00:00+08', TIMESTAMPTZ '2026-03-22 08:00:00+08');
