...
INSERT INTO batch.job_definition (
    ...
    (2004, 'default-tenant', 'general_fixed_rate_job', 'General Fixed Rate Job', 'GENERAL', 'HOUSEKEEPING', 'FIXED_RATE', NULL, 'Asia/Shanghai', 2, 'dispatch_queue', 'dispatch', 'prev-workday-calendar', 'business_hours', 'SCHEDULED', FALSE, 'NONE', 'NONE', 0, 1800, 'com.example.GeneralFixedRateJobHandler', jsonb_build_object('type', 'object'), jsonb_build_object('kind', 'fixedRate'), 1, TRUE, 'Covers GENERAL + FIXED_RATE + NONE', 'system', 'system', TIMESTAMPTZ '2026-03-22 09:00:00+08', TIMESTAMPTZ '2026-03-22 09:00:00+08'),
