...
- "状态主机"一词在 docs/agent-baseline.md 及约 30 篇文档中作为"orchestrator 唯一状态权威"的既定术语使用。其字面("主机")易被理解为物理机,建议未来做一次项目级术语评审决定是否统一改为"状态权威 / 状态机";因涉及面广(含 docs/agent-baseline.md),本次文档清理未改动,保持一致。
