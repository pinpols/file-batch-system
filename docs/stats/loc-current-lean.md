...
> 口径：git 跟踪文件；排除 `docs/`、构建产物、生成物、依赖目录和 Flyway migration；主指标为 **Lean logical LOC**，用语句/块/配置项计数削弱格式化换行带来的膨胀。生成来源：HEAD `40d57e100` + 当前工作区改动。

## 总览

| Files | Physical LOC | Lean logical LOC | Lean/Physical |
|---:|---:|---:|---:|
| 4,531 | 466,101 | 234,993 | 50.4% |

## 按用途

| Group | Files | Physical LOC | Lean logical LOC | Lean/Physical |
|---|---:|---:|---:|---:|
| prod | 2,641 | 240,850 | 109,908 | 45.6% |
| test | 1,158 | 166,586 | 88,570 | 53.2% |
| script | 589 | 43,386 | 27,035 | 62.3% |
| config | 52 | 7,860 | 5,549 | 70.6% |
...
|---|---:|---:|---:|---:|
| Java | 3,353 | 342,959 | 173,873 | 50.7% |
