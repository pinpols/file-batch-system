...
> 口径：git 跟踪文件；排除 `docs/`、构建产物、生成物、依赖目录和 Flyway migration；主指标为 **Lean logical LOC**，用语句/块/配置项计数削弱格式化换行带来的膨胀。生成来源：HEAD `ba22aae63` + 当前工作区改动。

## 总览

| Files | Physical LOC | Lean logical LOC | Lean/Physical |
|---:|---:|---:|---:|
| 4,528 | 465,813 | 234,833 | 50.4% |

## 按用途

| Group | Files | Physical LOC | Lean logical LOC | Lean/Physical |
|---|---:|---:|---:|---:|
| prod | 2,640 | 240,821 | 109,891 | 45.6% |
| test | 1,158 | 166,581 | 88,571 | 53.2% |
| script | 587 | 43,120 | 26,890 | 62.4% |
...
|---|---:|---:|---:|---:|
| Java | 3,352 | 342,925 | 173,857 | 50.7% |
| Shell | 181 | 27,136 | 20,898 | 77.0% |
| Python | 200 | 26,737 | 13,480 | 50.4% |
