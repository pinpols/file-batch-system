...
> 口径：git 跟踪文件；排除 `docs/`、构建产物、生成物、依赖目录和 Flyway migration；主指标为 **Lean logical LOC**，用语句/块/配置项计数削弱格式化换行带来的膨胀。生成来源：HEAD `bbbb3e217` + 当前工作区改动。

## 总览

| Files | Physical LOC | Lean logical LOC | Lean/Physical |
|---:|---:|---:|---:|
| 4,529 | 465,990 | 234,905 | 50.4% |

## 按用途

| Group | Files | Physical LOC | Lean logical LOC | Lean/Physical |
|---|---:|---:|---:|---:|
| prod | 2,640 | 240,831 | 109,897 | 45.6% |
| test | 1,158 | 166,584 | 88,571 | 53.2% |
| script | 588 | 43,284 | 26,956 | 62.3% |
| config | 52 | 7,872 | 5,550 | 70.5% |
...
|---|---:|---:|---:|---:|
| Java | 3,352 | 342,938 | 173,863 | 50.7% |
| Shell | 181 | 27,152 | 20,914 | 77.0% |
| Python | 201 | 26,885 | 13,530 | 50.3% |
| YAML | 95 | 12,043 | 9,004 | 74.8% |
