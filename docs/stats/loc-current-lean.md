...
> 口径：git 跟踪文件；排除 `docs/`、构建产物、生成物、依赖目录和 Flyway migration；主指标为 **Lean logical LOC**，用语句/块/配置项计数削弱格式化换行带来的膨胀。生成来源：HEAD `1164f20dd`。

## 总览

| Files | Physical LOC | Lean logical LOC | Lean/Physical |
|---:|---:|---:|---:|
| 4,533 | 466,519 | 235,259 | 50.4% |

## 按用途

| Group | Files | Physical LOC | Lean logical LOC | Lean/Physical |
|---|---:|---:|---:|---:|
| prod | 2,641 | 240,894 | 109,937 | 45.6% |
| test | 1,158 | 166,716 | 88,638 | 53.2% |
...
|---|---:|---:|---:|---:|
| Java | 3,353 | 343,128 | 173,963 | 50.7% |
