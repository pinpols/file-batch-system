...
class DispatchChannelGatewayTest {
    ...
    void setUp() {
        ...
        gateway = new DispatchChannelGateway(List.of(httpAdapter), circuitBreaker, deliveryMetrics, healthService);
    }
    ...
    void shouldBlockWhenCircuitIsOpen() {
        ...
        DispatchChannelGateway gatewayWithOpenCircuit =
                new DispatchChannelGateway(List.of(httpAdapter), shortBreaker, deliveryMetrics, healthService);
