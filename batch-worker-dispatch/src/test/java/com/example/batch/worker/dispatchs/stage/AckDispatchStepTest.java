...
class AckDispatchStepTest {
    ...
    void execute_setsPendingStatusWhenReceiptPending() {
        ...
        DispatchPayload payload = new DispatchPayload("10", null, "CH1", null, null, null, null, null, null, null);
        DispatchResult dispatchResult = new DispatchResult(true, "ext-1", null, false, true, "ok", null);
    ...
    void execute_fallsBackToFileIdReceiptCodeWhenBothNull() {
        ...
        DispatchPayload payload = new DispatchPayload("10", null, "CH1", null, null, null, null, null, null, null);
        DispatchResult dispatchResult = new DispatchResult(true, "ext-1", null, true, false, "ok", null);
    ...
    void execute_succeedsWithoutAckWhenNeitherAcknowledgedNorPending() {
        ...
        DispatchPayload payload = new DispatchPayload("10", null, "CH1", null, null, null, null, null, null, null);
        DispatchResult dispatchResult = new DispatchResult(true, "ext-1", null, false, false, "ok", null);
    ...
    private DispatchJobContext buildContextWithAckedResult(String receiptCode) {
        DispatchPayload payload = new DispatchPayload("10", null, "CH1", null, null, receiptCode, null, null, null, null);
        DispatchResult dispatchResult = new DispatchResult(true, "ext-1", receiptCode, true, false, "ok", null);
