...
public final class E2eScenarioFixture {
    ...
    public static final class LaunchPreparationSpec {
        ...
        public LaunchPreparationSpec(JdbcTemplate jdbc,
                                     String tenantId,
                                     String jobType,
                                     String workerGroup,
    ...
    public static LaunchSeed prepareLaunchWithoutPreSeededWorker(JdbcTemplate jdbc,
                                                                 ...
                                                                 String workerGroup,
                                                                 TriggerType triggerType) {
        return prepareLaunchWithoutPreSeededWorker(new LaunchPreparationSpec(
                jdbc, tenantId, jobType, workerGroup, triggerType));
    }
        ...
        spec.jdbc().update(
                """
                        insert into batch.job_definition (
                            ...
                            ?, ?, 0, true, 1)
                        """,
                spec.tenantId(), jobCode, "e2e " + jobCode, spec.jobType(), "E2E",
                spec.workerGroup(), spec.retryPolicy(), spec.retryMaxCount());
