...
class DeadLetterApprovalReplayE2eIT extends AbstractIntegrationTest {
    ...
    void deadLetterCanBeApprovedAndReplayedThroughConsoleHttp() throws Exception {
        ...
        LaunchSeed seed = E2eScenarioFixture.prepareLaunchWithoutPreSeededWorker(
                jdbcTemplate, TENANT, "IMPORT", "import", com.example.batch.common.enums.TriggerType.API);
    ...
    private JsonNode postConsoleJson(String path, String body, String idempotencyKey) throws Exception {
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create("http://127.0.0.1:" + localServerPort + path))
                .header(CommonConstants.DEFAULT_TENANT_ID_HEADER, TENANT)
    ...
    private long seedReplayGraph(LaunchSeed seed, String traceId, Map<String, Object> params) throws Exception {
