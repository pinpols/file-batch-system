...
public final class E2eStatusLogger {
    ...
    public static void logJobFlowSnapshot(JdbcTemplate jdbcTemplate, String tenantId, String dedupKey, String label) {
    ...
    public static void logOutboxSnapshot(JdbcTemplate jdbcTemplate, String tenantId, String eventKey, String label) {
