...
public record CommonResponse<T>(ResultCode code, String message, T data, ResponseMeta meta) {
    public static <T> CommonResponse<T> success(T data) {
        return new CommonResponse<>(
                ResultCode.SUCCESS, ResultCode.SUCCESS.defaultMessage(), data, null);
    }

    public static <T> CommonResponse<T> success(T data, ResponseMeta meta) {
        return new CommonResponse<>(
                ResultCode.SUCCESS, ResultCode.SUCCESS.defaultMessage(), data, meta);
    }
    ...
    public static <T> CommonResponse<T> failure(
            ResultCode code, String message, ResponseMeta meta) {
