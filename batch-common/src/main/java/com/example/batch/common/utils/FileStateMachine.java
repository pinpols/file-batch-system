...
public final class FileStateMachine {
    ...
    private static final Map<FileStatus, EnumSet<FileStatus>> TRANSITIONS =
            Map.ofEntries(
                    ...
                    Map.entry(
                            FileStatus.PARSED, EnumSet.of(FileStatus.VALIDATED, FileStatus.FAILED)),
                    Map.entry(
                            FileStatus.VALIDATED, EnumSet.of(FileStatus.LOADED, FileStatus.FAILED)),
                    Map.entry(
                            FileStatus.LOADED, EnumSet.of(FileStatus.ARCHIVED, FileStatus.FAILED)),
                    Map.entry(
                    ...
                    Map.entry(
                            FileStatus.DISPATCHING,
                            EnumSet.of(FileStatus.DISPATCHED, FileStatus.FAILED)),
                    Map.entry(
