 ...
 *
 * <p>对齐 SDK 端 {@code io.github.pinpols.batch.sdk.task.SdkTaskTypeDescriptor}(字段名必须 1:1,jackson 跨端
 * 反序列化,见 orchestrator {@code SdkWireContractTest})。orchestrator register handler 据此 upsert 到 {@code
