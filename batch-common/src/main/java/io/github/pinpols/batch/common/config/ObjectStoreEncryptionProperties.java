 ...
 * put，若同时再启用 {@link io.github.pinpols.batch.common.storage.EncryptingObjectStore} 装饰会双重加密。 future 把
...
public class ObjectStoreEncryptionProperties {
   ...
   * io.github.pinpols.batch.common.storage.EncryptingObjectStore}。
   */
