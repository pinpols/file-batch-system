...
deploy/docker/compose/app.yml 默认 :-false 的 bug，导致行为静默不一致。
本脚本作为 CI 回退，确保两边 default 永远对齐。
...
from feature_switch_registry import compose_required_env_vars
...
def main() -> int:
    ...
    compose_files = [
        ...
        ROOT / "deploy/docker/compose/app.yml",
