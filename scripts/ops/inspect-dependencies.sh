...
PG_PORT="${BATCH_INFRA_PG_PORT:-$PGPORT}"
PG_DATABASE="${BATCH_INFRA_PG_DATABASE:-$PGDATABASE}"
PG_USER="${BATCH_INFRA_PG_USER:-$PGUSER}"
PG_CONTAINER="${BATCH_INFRA_PG_CONTAINER:-$PG_CONTAINER}"
KAFKA_BOOTSTRAP="${BATCH_INFRA_KAFKA_BOOTSTRAP:-${BATCH_OBSERVABILITY_KAFKA_BOOTSTRAP_SERVERS:-$KAFKA_HOST_BOOTSTRAP}}"
KAFKA_CONTAINER="${BATCH_INFRA_KAFKA_CONTAINER:-$BATCH_DEFAULT_KAFKA_CONTAINER}"
KAFKA_CONTAINER_BOOTSTRAP="${BATCH_INFRA_KAFKA_CONTAINER_BOOTSTRAP:-$KAFKA_CONTAINER_BOOTSTRAP}"
...
VALKEY_HOST="${BATCH_INFRA_VALKEY_HOST:-$BATCH_DEFAULT_REDIS_HOST}"
VALKEY_PORT="${BATCH_INFRA_VALKEY_PORT:-${REDIS_PORT:-$BATCH_DEFAULT_REDIS_PORT}}"
VALKEY_CONTAINER="${BATCH_INFRA_VALKEY_CONTAINER:-$BATCH_DEFAULT_REDIS_CONTAINER}"
VALKEY_PASSWORD="${BATCH_INFRA_VALKEY_PASSWORD:-${REDIS_PASSWORD:-}}"
MINIO_ENDPOINT="${BATCH_INFRA_MINIO_ENDPOINT:-http://localhost:${MINIO_API_PORT:-$BATCH_DEFAULT_MINIO_API_PORT}}"
MINIO_BUCKET_NAME="${BATCH_INFRA_MINIO_BUCKET:-${MINIO_BUCKET:-$BATCH_DEFAULT_MINIO_BUCKET}}"
