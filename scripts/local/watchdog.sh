...
#     worker-import / worker-export / worker-process / worker-dispatch / worker-atomic 8 个进程是否存在。
...
# 监控的 7 个模块（与 jar 名匹配）
MODULES=(trigger orchestrator console worker-import worker-export worker-process worker-dispatch worker-atomic)
