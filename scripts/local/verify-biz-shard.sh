...
#
#   shard-0 = 已在跑的 primary 容器的 batch_business(基线库)
#   shard-1 = 本脚本通过 BIZ_SHARD_1_CONTAINER / BIZ_SHARD_1_PORT 指向的验证实例
#
...
PLATFORM_URL="jdbc:postgresql://localhost:${POSTGRES_PORT:-15432}/${PLATFORM_DB}"
