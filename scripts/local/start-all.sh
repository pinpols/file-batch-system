...
WORKERS="${WORKERS:-import,export,process,dispatch,spi}"
...
echo "  console-api 18080 | trigger 18081 | orchestrator 18082 | import 18083 | export 18084 | process 18086 | dispatch 18085 | spi 18087"
