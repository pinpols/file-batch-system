TRUNCATE TABLE
  ...
  batch.job_instance, batch.job_instance_dedup_key, batch.job_partition, batch.job_task,
  batch.job_step_instance, batch.job_execution_log,
  batch.workflow_run, batch.workflow_node_run,
  batch.outbox_event, batch.outbox_event_dedup_key, batch.event_delivery_log, batch.event_outbox_retry,
