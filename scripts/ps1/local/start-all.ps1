...
Write-Host "==> 检查应用端口占用..."
@("orchestrator", "trigger", "console", "worker-import", "worker-export", "worker-process", "worker-dispatch") | ForEach-Object {
...
Write-Host "  console-api 18080 | trigger 18081 | orchestrator 18082 | import 18083 | export 18084 | process 18086 | dispatch 18085"
