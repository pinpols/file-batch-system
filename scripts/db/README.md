...
- [flyway/](./flyway/) - 平台 Flyway **说明**（`V*.sql` 仅维护在 `batch-orchestrator/src/main/resources/db/migration/`）
...
2. 平台库结构变更（含 Quartz 元数据表）只改 [batch-orchestrator 内 db/migration](../../batch-orchestrator/src/main/resources/db/migration/)，并阅读 [flyway/README.md](./flyway/README.md) 了解约定
