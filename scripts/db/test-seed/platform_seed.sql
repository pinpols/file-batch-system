...
INSERT INTO batch.job_definition (
    ...
    (2004, 'default-tenant', 'atomic_shell_demo', 'Atomic Shell Demo', 'ATOMIC', 'GENERAL', 'MANUAL', NULL, 'Asia/Shanghai', 5, 'atomic_queue', 'atomic', 'default-calendar', 'always_open', 'MANUAL', FALSE, 'STATIC', 'EXPONENTIAL', 1, 300, NULL, jsonb_build_object('type', 'object'), jsonb_build_object('taskType', 'shell', 'command', '/bin/echo', 'args', jsonb_build_array('hello-from-atomic')), 1, TRUE, '原子任务示例:shell', 'system', 'system', TIMESTAMPTZ '2026-05-30 08:00:00+08', TIMESTAMPTZ '2026-05-30 08:00:00+08'),
    (2005, 'default-tenant', 'atomic_sql_demo', 'Atomic SQL Demo', 'ATOMIC', 'GENERAL', 'MANUAL', NULL, 'Asia/Shanghai', 5, 'atomic_queue', 'atomic', 'default-calendar', 'always_open', 'MANUAL', FALSE, 'STATIC', 'EXPONENTIAL', 1, 300, NULL, jsonb_build_object('type', 'object'), jsonb_build_object('taskType', 'sql', 'sql', 'SELECT 1'), 1, TRUE, '原子任务示例:sql(只读 SELECT)', 'system', 'system', TIMESTAMPTZ '2026-05-30 08:00:00+08', TIMESTAMPTZ '2026-05-30 08:00:00+08'),
    (2006, 'default-tenant', 'atomic_stored_proc_demo', 'Atomic Stored Proc Demo', 'ATOMIC', 'GENERAL', 'MANUAL', NULL, 'Asia/Shanghai', 5, 'atomic_queue', 'atomic', 'default-calendar', 'always_open', 'MANUAL', FALSE, 'STATIC', 'EXPONENTIAL', 1, 300, NULL, jsonb_build_object('type', 'object'), jsonb_build_object('taskType', 'stored_proc', 'procedureName', 'batch.refresh_metrics'), 1, TRUE, '原子任务示例:stored-proc', 'system', 'system', TIMESTAMPTZ '2026-05-30 08:00:00+08', TIMESTAMPTZ '2026-05-30 08:00:00+08'),
