...
INSERT INTO batch.worker_registry (
    ...
    (1505, 'tenant-finance', 'finance-export-node', 'export', 'finance-export-host', '127.0.0.3', '10005', jsonb_build_object('formats', jsonb_build_array('DELIMITED','EXCEL'), 'role', 'export'), 'finance', 'ONLINE', TIMESTAMPTZ '2026-03-22 08:15:00+08', TIMESTAMPTZ '2026-03-22 08:00:00+08', 'v1', 0, NULL, NULL, TIMESTAMPTZ '2026-03-22 08:00:00+08', TIMESTAMPTZ '2026-03-22 08:00:00+08');
