...
INSERT INTO batch.file_channel_config (
    ...
    (5105, 'default-tenant', 'oss_dispatch', 'OSS Dispatch', 'OSS', NULL, 'TOKEN', jsonb_build_object('oss_bucket', 'batch-dev', 'oss_object_prefix', 'dispatch/', 'receipt_policy', 'POLLING', 'receipt_poll_url', 'http://localhost:19000/receipt'), 'POLLING', 30, TRUE, TIMESTAMPTZ '2026-03-22 08:00:00+08', TIMESTAMPTZ '2026-03-22 08:00:00+08'),
