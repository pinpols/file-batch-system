...
public class ActiveTaskLeaseRegistry {
   ...
   *
   * <p>由 {@link io.github.pinpols.batch.worker.core.support.TaskExecutionWrapper#execute} 在 report
   * 前 检查 {@link #isLost}：若已 lost，应放弃当前执行结果（orchestrator 已重新派发给别的 worker）。
   */
