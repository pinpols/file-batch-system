...
public interface ProcessStagingMapper {
   ...
   *
   * <p>分区名 / 边界全部由 {@link com.example.batch.worker.processes.cleanup.ProcessStagingOrphanCleaner}
   * 从日期派生(形如 {@code process_staging_p20260607} / {@code 2026-06-07 00:00:00+00}),非用户输入,无注入面。父表索引由
   * PG 自动附加到新分区。
   *
